...
export const brand = {
  ...
  logos: {
    event: { src: pioneersCircleLogo, alt: 'Pioneers Circle 2026 — Viva la Colaboración' },
...
export const copy = {
  register: {
    ...
    subtitle: 'Register your selfie, and you can access all your photos after the event',
    note: 'Powered by AI and face recognition',
    submit: 'Register Now',
  },
  searching: {
    title: 'Finding your photos',
    subtitle: 'Our AI is matching your face across the event gallery. This takes a few seconds.',
  },
  results: {
